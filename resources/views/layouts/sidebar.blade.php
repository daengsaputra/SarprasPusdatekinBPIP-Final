    ...
    <div class="deznav-scroll">
        <ul class="metismenu sarpras-menu-list" id="menu">
            ...
            <li class="{{ request()->routeIs('dashboard') || request()->routeIs('home') ? 'mm-active' : '' }}">
                <a href="{{ route('dashboard') }}" class="ai-icon sarpras-menu-link {{ request()->routeIs('dashboard') || request()->routeIs('home') ? 'active' : '' }}">
            ...
            <li class="{{ request()->routeIs('assets.loanable') ? 'mm-active' : '' }}">
                <a href="{{ route('assets.loanable') }}" class="ai-icon sarpras-menu-link {{ request()->routeIs('assets.loanable') ? 'active' : '' }}">
            ...
            <li class="{{ request()->routeIs('assets.index') ? 'mm-active' : '' }}">
                <a href="{{ route('assets.index') }}" class="ai-icon sarpras-menu-link {{ request()->routeIs('assets.index') ? 'active' : '' }}">
            ...
            <li class="{{ request()->routeIs('loans.*') ? 'mm-active' : '' }}">
                <a href="{{ route('loans.index') }}" class="ai-icon sarpras-menu-link {{ request()->routeIs('loans.*') ? 'active' : '' }}">
            ...
            <li class="{{ request()->routeIs('reports.loans*') ? 'mm-active' : '' }}">
                <a href="{{ route('reports.loans') }}" class="ai-icon sarpras-menu-link {{ request()->routeIs('reports.loans*') ? 'active' : '' }}">
            ...
            <li class="{{ request()->routeIs('reports.returns*') ? 'mm-active' : '' }}">
                <a href="{{ route('reports.returns') }}" class="ai-icon sarpras-menu-link {{ request()->routeIs('reports.returns*') ? 'active' : '' }}">
            ...
            <li class="{{ request()->routeIs('users.*') ? 'mm-active' : '' }}">
                <a href="{{ route('users.index') }}" class="ai-icon sarpras-menu-link {{ request()->routeIs('users.*') ? 'active' : '' }}">
            ...
            <li class="{{ request()->routeIs('settings.landing*') ? 'mm-active' : '' }}">
                <a href="{{ route('settings.landing') }}" class="ai-icon sarpras-menu-link {{ request()->routeIs('settings.landing*') ? 'active' : '' }}">
